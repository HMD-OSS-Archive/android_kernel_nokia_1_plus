...
static void sensor_init(void)
{
   ...
   // +++++++++++++++++++++++++++//                                                               
	// Reset for operation     
	//Streaming off
	//S5K5E9_EVT0_Reference_setfile_v0.4d_180503
	write_cmos_sensor(0x0100, 0x00);
...
static void preview_setting(void)
{
	...
	for (i = 0; i < 100; i++)
	{
	     kal_uint16  framecnt = read_cmos_sensor(0x0005); /* waiting for sensor to  stop output  then  set the  setting */
	     if (framecnt == 0xFF)
	     {
...
EXPORT_SYMBOL(S5K5E9_MIPI_RAW_SensorInit);
