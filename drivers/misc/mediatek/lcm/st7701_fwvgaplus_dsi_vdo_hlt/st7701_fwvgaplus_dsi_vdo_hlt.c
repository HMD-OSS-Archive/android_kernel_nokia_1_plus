...
#else
#define LCD_DEBUG(fmt, args...)  printk(KERN_ERR "[KERNEL/HLT LCM]"fmt, ##args)
#endif
...
struct LCM_DRIVER st7701_fwvgaplus_dsi_vdo_hlt_lcm_drv =
{
    .name           	= "st7701_fwvgaplus_dsi_vdo_hlt",
