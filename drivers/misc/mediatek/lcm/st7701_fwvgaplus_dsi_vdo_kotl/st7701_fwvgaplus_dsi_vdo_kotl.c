...
#define ROUND_CORNER_W 8
#define ROUND_CORNER_H 8
#endif

#ifdef BUILD_LK
#define LCD_DEBUG(fmt, args...)  dprintf(CRITICAL, fmt)
#else
#define LCD_DEBUG(fmt, args...)  printk(KERN_ERR "[KERNEL/KOTL LCM]"fmt, ##args)
#endif
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.LANE_NUM			= 2;	// 3
	params->dsi.PLL_CLOCK			= 223;  //3lane

#ifdef CONFIG_MTK_ROUND_CORNER_SUPPORT
	params->round_corner_en=1;
	params->corner_pattern_width=ROUND_CORNER_W;
...
extern int fih_lcm_vgp_supply_enable(void);
extern int fih_lcm_vgp_supply_disable(void);
extern int fih_lcm_get_vgp_supply(void);

static void lcm_init_power(void)
{
	LCD_DEBUG("st7701_lcm_init power done\n");
}
static void lcm_suspend_power(void)
{
#ifdef CONFIG_FIH_LCM_VGP_SUPPLY
	fih_lcm_vgp_supply_disable();
#endif
	LCD_DEBUG("st7701_lcm_suspend_power done\n");
}
static void lcm_resume_power(void)
{
#ifdef CONFIG_FIH_LCM_VGP_SUPPLY
	fih_lcm_vgp_supply_enable();
#endif
	LCD_DEBUG("st7701_lcm_resume_power done\n");
}
...
struct LCM_DRIVER st7701_fwvgaplus_dsi_vdo_kotl_lcm_drv =
{
    .name           	= "st7701_fwvgaplus_dsi_vdo_kotl",
