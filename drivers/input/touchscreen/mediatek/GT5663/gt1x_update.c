...
#define CONFIG_FILE_PATH_1_2        "/vendor/firmware/goodix_config_2.cfg"
#define CONFIG_FILE_PATH_2_2        "/sdcard/firmware/goodix_config_2.cfg"
	...
	while (retry-- > 0) {
		...
		switch(id){
			...
			case 1://KOTL
				...
				break;
			case 2://COE
				config_path_vendor = CONFIG_FILE_PATH_1_2;
				config_path_sdcard = CONFIG_FILE_PATH_2_2;
				break;
			default:
