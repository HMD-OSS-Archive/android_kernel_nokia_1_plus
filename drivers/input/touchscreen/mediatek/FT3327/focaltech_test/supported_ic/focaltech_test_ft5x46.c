...
unsigned char FT5X46_TestItem_EnterFactoryMode(void)
{
    ...
    for (i = 1; i <= iRedo; i++) {
        ...
        if (ERROR_CODE_OK != ReCode) {
            FTS_TEST_SAVE_INFO_RESULT("Failed to Enter factory mode!\n");
            if (i < iRedo) {
                sys_delay(50);
                continue;
            }
...
unsigned char FT5X46_TestItem_RawDataTest(bool *bTestResult)
{
    ...
    if ( btmpresult ) {
        *bTestResult = true;
        FTS_TEST_SAVE_INFO_RESULT("RawData Test is OK!\n");
    } else {
        * bTestResult = false;
...
unsigned char FT5X46_TestItem_SCapRawDataTest(bool *bTestResult)
{
    ...
    if ( btmpresult ) {
        *bTestResult = true;
        FTS_TEST_SAVE_INFO_RESULT("SCap RawData Test is OK!\n");
    } else {
        * bTestResult = false;
        FTS_TEST_SAVE_INFO_RESULT("SCap RawData Test is NG!\n");
    }
    return ReCode;
...
unsigned char FT5X46_TestItem_SCapCbTest(bool *bTestResult)
{
    ...
    if ( btmpresult ) {
        *bTestResult = true;
        FTS_TEST_SAVE_INFO_RESULT("SCap CB Test Test is OK!\n");
    } else {
        * bTestResult = false;
        FTS_TEST_SAVE_INFO_RESULT("SCap CB Test Test is NG!\n");
    }
    return ReCode;
...
unsigned char FT5X46_TestItem_PanelDifferTest(bool *bTestResult)
{
    ...
    if ( btmpresult ) {
        *bTestResult = true;
        FTS_TEST_SAVE_INFO_RESULT("Panel Differ Test is OK!\n");
    } else {
        * bTestResult = false;
        FTS_TEST_SAVE_INFO_RESULT("Panel Differ Test is NG!\n");
    }
    return ReCode;
...
TEST_ERR:
    ...
    if ( btmpresult ) {
        FTS_TEST_SAVE_INFO_RESULT("Weak Short Test is OK.\n");
        * bTestResult = true;
    } else {
        FTS_TEST_SAVE_INFO_RESULT("Weak Short Test is NG.\n");
        * bTestResult = false;
    }
