...
struct charger_custom_data {
	...
	int jeita_temp_above_t4_ichg_current;
	int jeita_temp_t3_to_t4_ichg_current;
	int jeita_temp_t2_to_t3_ichg_current;
	int jeita_temp_t1_to_t2_ichg_current;
	int jeita_temp_t0_to_t1_ichg_current;
	int jeita_temp_below_t0_ichg_current;
	int temp_t4_thres;
